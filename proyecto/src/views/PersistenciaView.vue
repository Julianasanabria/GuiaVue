        ...
        <q-card class="my-card">
            ...
            <q-card-section>
                ...
                <p class="text-body1 q-mt-md">
                    Por defecto, cualquier dato en tus componentes de Vue (en <code>data</code> o <code>ref</code>) se pierde cuando el usuario recarga la página. La <b>persistencia</b> es la técnica de guardar estos datos en un almacenamiento más duradero, como el navegador del usuario, para que la información se mantenga entre sesiones.
                </p>
            </q-card-section>
            ...
            <q-card-section>
                ...
                <q-list bordered separator>
                    ...
                    <q-item>
                        <q-item-section>
                            <q-item-label class="text-h6"><code>localStorage</code></q-item-label>
...
// Guardar un objeto (hay que convertirlo a string)
...
localStorage.clear();
                    ...
                    <q-item>
                        <q-item-section>
                            <q-item-label class="text-h6"><code>sessionStorage</code></q-item-label>
                            <q-item-label caption>Almacenamiento por sesión (por pestaña).</q-item-label>
                            <p class="q-mt-sm">
                                Funciona igual que <code>localStorage</code>, pero los datos <b>se eliminan automáticamente</b> cuando se cierra la pestaña del navegador. Es útil para datos temporales que no deben persistir indefinidamente.
                            </p>
                        </q-item-section>
                    </q-item>
                </q-list>
            ...
            <q-card-section>
                ...
                <p class="text-body1">
                    Manejar la persistencia manualmente puede ser repetitivo. Para Pinia, la solución recomendada es usar el plugin <code>pinia-plugin-persistedstate</code>, que automatiza todo el proceso.
                </p>
                <!-- Instalación -->
...
app.use(pinia)
                ...
                <p>Una vez configurado, solo necesitas añadir la opción <code>persist: true</code> a tu store.</p>
                <q-banner class="bg-grey-2 q-mt-sm">
                    <code class="code-block" v-pre>
...
export const useUserStore = defineStore('user', {
  ...
  persist: true
                ...
                <p>Puedes personalizar el comportamiento de la persistencia pasando un objeto a la opción <code>persist</code>.</p>
                <q-banner class="bg-grey-2 q-mt-sm">
                    <code class="code-block" v-pre>
                ...
                <q-list bordered separator>
                    <q-item>
                        ...
                        <q-item-section>
                            ...
                            <q-item-label caption><code>localStorage</code> es accesible por cualquier script en tu página. Nunca guardes contraseñas, tokens de alta seguridad o información personal identificable.</q-item-label>
                        </q-item-section>
                    </q-item>
                    <q-item>
